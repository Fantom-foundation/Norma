...
func NewERC20Application(rpcClient transact.RpcClient, primaryAccount *transact.Account) (*ERC20Application, error) {
...
func (f *ERC20Application) CreateGenerator(rpcClient transact.RpcClient) (TransactionGenerator, error) {
	// get price of gas from the network
...
func (f *ERC20Application) WaitUntilApplicationIsDeployed(rpcClient transact.RpcClient) error {
	return transact.WaitUntilAccountNonceIs(f.primaryAccount.Address, f.primaryAccount.GetCurrentNonce(), rpcClient)
}

func (f *ERC20Application) GetTransactionCounts(rpcClient transact.RpcClient) (TransactionCounts, error) {
