...
func (m *MockHost) GetIP() (IP, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHostMockRecorder) GetIP() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIP", reflect.TypeOf((*MockHost)(nil).GetIP))
}
